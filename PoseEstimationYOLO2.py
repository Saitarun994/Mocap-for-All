...
import sys 
sys.path.append('C:/Users/tarun/Desktop/Pose Transfer Project/YOLOV7/yolov7-pose-estimation/')
sys.path.append('C:/Users/tarun/Desktop/Pose Transfer Project/YOLOV7/yolov7-pose-estimation/utilsr')
from utilsr.datasets import letterbox
from utilsr.torch_utils import select_device
from models.experimental import attempt_load
from utilsr.general import non_max_suppression_kpt,strip_optimizer,xyxy2xywh
from utilsr.plots import output_to_keypoint, plot_skeleton_kpts,colors,plot_one_box_kpt
...
def parse_opt():
    ...
    parser.add_argument('--poseweights', nargs='+', type=str, default='C:/Users/tarun/Desktop/Pose Transfer Project/YOLOV7/yolov7-pose-estimation/yolov7-w6-pose.pt', help='model path(s)')
